...
export { proprietarioRepository, estabelecimentoRepository, enderecoRepository, horarioRepository, cardapioRepository, categoriaRepository, subcategoriaRepository, produtoRepository };
